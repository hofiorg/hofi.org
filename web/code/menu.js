  ...
  var dartmenu = [
    {label: 'Prozess starten', title: 'Dart - Prozess starten',      url: 'dart/process.html', tag:'dart_process'},
    {label: 'Videos',          title: 'Dart - Videos',               url: 'dart/videos.html',  tag:'dart_videos'},
    {label: 'where',           title: 'Dart - iterate a collection', url: 'dart/where.html',   tag:'dart_where'},
  ];

  var htmlmenu = [
    {label: 'Abgerundete Bilder', title: 'CSS - Abgerundete Bilder',         url: 'css/round_image.html',          tag:'css_round_image'},
    {label: 'Google+ Kommentare', title: 'Google Plus Kommentare einbinden', url: 'css/google_plus_comments.html', tag:'google_plus_comments'},
  ];  

  var javascriptmenu = [
    {label: 'httpGet',    title: 'Javascript - httpGet',    url: 'javascript/http_get.html',    tag:'javascript_http_get'},
    {label: 'replaceAll', title: 'Javascript - replaceAll', url: 'javascript/replace_all.html', tag:'javascript_replace_all'},
  ];    

  var polymermenu = [
    {label: 'Paper Icon Buttons', title: 'Polymer - Paper Icon Buttons', url: 'polymer/paper_icon_buttons.html', tag:'polymer_paper_icon_buttons'},
    {label: 'Scrollbarer Header', title: 'Polymer - Scrollbarer Header', url: 'polymer/header.html',             tag:'polymer_header'},
    {label: 'Videos',             title: 'Polymer - Videos',             url: 'polymer/videos.html',             tag:'polymer_videos'},
  ];  

  var vorlesung_1 = [
    {label: 'Unterlagen', title: '&Uuml;bungsunterlagen',   url: 'vorlesung_1/unterlagen.html', tag:'vorlesung_1_unterlagen'},
    ...
    /*{label: '18.12.2014', title: 'Vorlesung am 18.12.2014', url: 'vorlesung_2/2014_12_18.html', tag:'vorlesung_2_2014_12_18'}, */
  ];    

  var vorlesung_2 = [
    {label: 'Unterlagen', title: '&Uuml;bungsunterlagen',   url: 'vorlesung_2/unterlagen.html', tag:'vorlesung_2_unterlagen'},
  ...
  template.menus = [
    ...
    {id: 'vorlesung_1',       label: 'Vorlesung WI - 1', sub: vorlesung_1},
    {id: 'vorlesung_2',       label: 'Vorlesung WI - 2', sub: vorlesung_2},
